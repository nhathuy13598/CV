...
\section{Experience}
  \resumeSubHeadingListStart
      ...
      \resumeItemListStart
        \resumeItem{I build high-performance data pipelines that ingest data in various formats (XML, JSON, CSV) and transform it into a structured format for real-time analysis used in high-frequency trading (HFT).}
